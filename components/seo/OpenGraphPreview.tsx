  ...
  return (
    ...
    >
      <div className="relative aspect-[1.91/1] bg-[var(--color-gray-100)]">
        {imageURL ? (
          ...
          <div className="flex size-full items-center justify-center bg-[radial-gradient(circle_at_center,rgba(200,169,106,0.35),transparent_60%),linear-gradient(13 5deg,#111111,#1e1c19)]">
    ...
    <div className="p-5">
     <p className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.14em] text-muted">
      ...
      <h3 className="mt-3 line-clamp-2 font-heading text-2xl font-medium tracking-[-0.025em] text-foreground">
       {title ||
