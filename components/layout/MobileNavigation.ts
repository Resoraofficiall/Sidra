  ...
  return (
   ...
   >
    ...
    <aside
      ...
      className={cn(
        "absolute right-0 top-0 flex h-full w-[min(88vw,420px)] flex-col border-l
border-[color:rgb(200_169_106_/_0.25)] bg-[var(--color-black-900)] p-6
text-[var(--color-ivory-100)] shadow-[var(--shadow-modal)] transition-transform
