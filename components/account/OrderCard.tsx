  ...
  >
    ...
    <div className="mt-5 flex flex-col gap-5 md:flex-row md:items-center md:justify-between">
     <div className="flex items-center">
      {previewItems.map(
        (item, index) => (
          <div
            ...
            className={cn(
              "relative size-16 overflow-hidden rounded-md border-2 border-card bg-[var(--color-gray-100)]",
              index > 0 && "-ml-3"
            )}
          >
      ...
      {remainingItems > 0 ? (
        <span className="-ml-3 flex size-16 items-center justify-center rounded-md border-2 border-card bg-[var(--color-black-900)] text-sm font-semibold text-white">
          +{remainingItems}
        </span>
      ) : null}
