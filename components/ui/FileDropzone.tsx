...
return (
 <div
   ...
   onDrop={handleDrop}
   className={cn(
     "relative flex min-h-64 flex-col items-center justify-center rounded-lg border-2 border-dashed px-6 py-10 text-center",
  ...
  >
   ...
   />
    ...
    <div className="flex size-16 items-center justify-center rounded-full border border-[color:rgb(200_169_106_/_0.28)] bg-[color:rgb(200_169_106_/_0.1)] text-[var(--color-gold-600)] shadow-[var(--shadow-gold-glow)]">
      {accept.some((type) =>
    ...
    <h3 className="mt-6 font-heading text-3xl font-medium tracking-[-0.02em] text-foreground">
      {label}
    </h3>
