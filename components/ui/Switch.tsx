  ...
  return (
   ...
   <button
    ...
    disabled={disabled}
       ...
       className={cn(
         "relative h-7 w-12 shrink-0 rounded-full border transition-colors duration-[var(--duration-base)]",
         checked
     ...
     >
       <span
         className={cn(
           "absolute top-0.5 size-5 rounded-full bg-white shadow transition-transform duration-[var(--duration-base)]",
