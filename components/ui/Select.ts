 ...
 return (
   <div className="relative">
     <select
      ...
      className={cn(
        "h-12 w-full appearance-none rounded-md border bg-card px-4 pr-11 text-base
text-foreground shadow-[var(--shadow-card)]",
        ...
        invalid
          ...
          : "border-border focus-visible:border-[var(--color-gold-500)]
