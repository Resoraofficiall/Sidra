      ...
      <div className="grid gap-2">
        {filteredItems.map((item) => (
          <button
              ...
              className={cn(
                "flex w-full items-center gap-4 rounded-md border border-transparent px-4 py-3
text-left",
             "transition-colors hover:border-[color:rgb(200_169_106_/_0.2)]
hover:bg-[color:rgb(200_169_106_/_0.08)]",
