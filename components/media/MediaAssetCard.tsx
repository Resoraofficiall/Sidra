...
export function MediaAssetCard({
 ...
 return (
  ...
  >
    ...
    >
      {isImage ? (
        <Image
          ...
          className="object-cover transition-transform duration-[var(--duration-slow)] group-hover:scale-[1.035]"
        />
      ):(
    ...
    {selected ? (
      <span className="absolute left-3 top-3 flex size-8 items-center justify-center rounded-full bg-[var(--color-gold-500)] text-[var(--color-black-900)] shadow-[var(--shadow-card)]">
        <Check
         aria-hidden="true"
         className="size-4"
        />
