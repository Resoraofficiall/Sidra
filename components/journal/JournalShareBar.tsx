 ...
 const openShareWindow = (
  ...
  return (
   <aside
     ...
     className={cn(
       "flex flex-wrap items-center gap-2 rounded-full border border-border bg-card p-2 shadow-[var(--shadow-card)]",
       className
     )}
   >
     <span className="ml-3 mr-2 inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.15em] text-muted">
       <Share2
         aria-hidden="true"
         className="size-3.5"
       />
