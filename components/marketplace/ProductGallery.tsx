...
export function ProductGallery({
   ...
   return (
     <div
       className={cn(
         ...
         "border border-border bg-[linear-gradient(135deg,var(--color-ivory-50),var(--color-gold-100))]",
         className
       )}
     >
 ...
 return (
  ...
  >
   <div className="relative aspect-square overflow-hidden rounded-[var(--radius-lg)] border border-border bg-[var(--color-gray-100)] shadow-[var(--shadow-card)]">
     <Image
      key={activeImage.id}
      src={activeImage.url}
      alt={
      ...
      className="object-cover animate-in fade-in-0 zoom-in-[0.985] duration-[var(--duration-slow)]"
     />
   </div>
